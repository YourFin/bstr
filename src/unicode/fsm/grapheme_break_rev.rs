...
//
//     regex-cli generate serialize sparse dfa --minimize --start-kind anchored --reverse --match-kind all --captures none --shrink --rustfmt --safe GRAPHEME_BREAK_REV src/unicode/fsm/ <snip: arg too long>
//
