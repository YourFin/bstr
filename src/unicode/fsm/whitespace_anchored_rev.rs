...
//
//     regex-cli generate serialize dense dfa --minimize --start-kind anchored --reverse --captures none --shrink --rustfmt --safe WHITESPACE_ANCHORED_REV src/unicode/fsm/ \s+
//
