...
//
//     regex-cli generate serialize dense dfa --minimize --start-kind anchored --reverse --captures none --shrink --rustfmt --safe REGIONAL_INDICATOR_REV src/unicode/fsm/ \p{gcb=Regional_Indicator}
//
